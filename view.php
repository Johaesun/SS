						...
						<p class="join_txt">금강컨트리클럽을 이용하시기 불편함 없도록 밝고 건강한 새로운 소식을 회원님께 알려드립니다.</p>
                                        <table id="view">
                                          <?php
                                            ...
                                            ?>
                                           <tr class="view_tr">
                                                <td></td><td>글제목:<?=$row['title']?></td>
                                            </tr>
                                            <tr class="view_tr">
                                                <td></td><td>조회수:<?=$row['count']?></td>
                                            </tr>
                                            <tr class="view_tr">
                                                <td></td><td>작성일:<?=$row['date']?></td>
                                            </tr>
                                            <tr class="view_tr"><td>내용</td><td><?=$row['notice']?></td></tr>
                                            <?php
                                               }
                                            ?>
                                        </table>
                                                    <p><a href="/update.php?idx=<?=$row['idx']?>">수정</a></p>
                                                       <p><a href="/delete.php?idx=<?=$row['idx']?>">삭제</a></p>  
